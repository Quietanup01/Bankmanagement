...
<body>
    <div class="container">
        ...
        <form method="POST" action="WithdrawFundsServlet" class="form">
            ...
            <div class="form-group">
                <input type="number" name="withdrawAmount" min="0.01" step="0.01" placeholder="Enter withdrawal amount" required>
            </div>
            <div class="form-group">
                <input type="date" name="transactionDate" id="transactionDate" readonly required>
            </div>
            <div class="form-group">
            ...
            <div class="form-actions">
                <button type="submit" class="form-submit">Confirm Withdrawal</button>
            </div>
    ...
    <script>
        ...
        <% if ("success".equals(request.getAttribute("status"))) { %>
            Swal.fire({
                ...
                html: 'Transaction Type: Withdrawal<br>Withdrawal Amount: <%= request.getAttribute("withdrawAmount") %><br>Withdrawal Date: <%= request.getAttribute("transactionDate") %>',
        ...
        <% } else if ("error".equals(request.getAttribute("status"))) { %>
            Swal.fire({
                ...
                window.location.href = 'withdraw_funds.jsp';
            });
        <% } %>
    </script>
</body>
